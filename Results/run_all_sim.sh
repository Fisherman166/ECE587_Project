...
set file=Results_Large_Assoc
set res_folder=Large_Assoc
# Cache specific
# Change values here 
set cache_type=dl2
set mem_Lat=150
...
set set_list=( 1024 512 256 128 64 32)      
set line_sz_list= ( 64 )
set assoc_list=( 32 16 8 4)  # for PLRU and Score not doing 2 it is pointless 
